...
public class NewSparePart extends SparePart{
    ...
    public NewSparePart(String brand, Category category, String model, String modelYear, Grade grade, SparePartType type, double costPrice, String sku) {
        super(brand.toUpperCase(), category, model.toUpperCase(), modelYear, type, costPrice);
        this.grade = grade;
        this.sku = sku;
