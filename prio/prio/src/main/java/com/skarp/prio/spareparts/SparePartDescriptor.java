...
public class SparePartDescriptor {
    ...
    private String name;            // Brand-Category-Model-Specification-Grade-Type
    ...
    public SparePartDescriptor(String brand, Category category, String model, String specification, Grade grade, String type, String SKU) {
        ...
        this.SKU = SKU;
        this.qty = 0;
        this.name = brand+" "+category+" "+model+" " + specification + ": "+grade+"-"+type;
    }
